# New York Home Health Holdings 401(k) Profit Sharing Plan — Knowledge Base
...
## Plan basics
- Official plan name: New York Home Health Holdings 401(k) Profit Sharing Plan. People also call it "the Honor Health Network 401(k)" or just "the 401(k) plan."
- Plan type: a defined contribution 401(k) profit sharing plan.
- Recordkeeper / provider: Capital Group (American Funds).
- Plan ID: IRK149167.
...
- Your own contributions, plus their earnings, are always 100% yours.
- The employer Safe Harbor match is 100% yours right away.
- Profit sharing contributions vest over time:
...
- Step-by-step guide: /forms/accessing-your-account.pdf
- On the site or app you can check your balance, change your contribution amount, change investments, view statements and tax forms, and update beneficiaries.
...
- Hardship Withdrawal Request: /forms/hardship-withdrawal-request.pdf
- Incoming Rollover Request: /forms/incoming-rollover-request.pdf
- Accessing Your Account guide: /forms/accessing-your-account.pdf
